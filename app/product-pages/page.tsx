...
const page = () => {
  ...
  return (
    <div>
      <div className="px-6 md:px-20 min-h-screen flex flex-col md:flex-row flex-wrap gap-10">
        <div className="scroll-animate-left py-[40px] mt-35 max-w-[400px] flex-1">
          <h2 className="text-[52px] font-bold mb-2">PRODUCTS</h2>
          <p className="text-[24px] font-bold uppercase text-black mb-1">
        ...
        <div className="grid grid-cols-1 py-[180px] lg:grid-cols-2 xl:grid-cols-4 gap-6 flex-1 scroll-animate-down">
