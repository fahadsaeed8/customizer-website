...
const page = () => {
  ...
  return (
    <div>
      <div className="px-6 md:px-20  md:py-[180px] min-h-screen flex flex-col md:flex-row flex-wrap gap-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-6 flex-1 scroll-animate-down">
