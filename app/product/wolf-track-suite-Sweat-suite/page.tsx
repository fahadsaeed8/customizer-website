...
export default function ProductPage() {
  ...
  const [selectedImage, setSelectedImage] = useState<string>(
    "/protomac-wolverines/Track-suite-Sweat-suite-1.jpg"
  );
  ...
  <div className="flex flex-col min-h-screen bg-white">
    <div className="flex-1 px-6 py-[190px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {/* Product Details */}
        <div>
          <h1 className="text-[38px] font-bold mb-2">Track-suite / Sweat suite</h1>
...
>
  Send inquiry
          ...
          <p className="text-lg text-black-500">
            <span className="font-bold">Category:</span> <span className="underline">Protomacs-wolveriens</span>
          </p>
        </div>
      </div>
