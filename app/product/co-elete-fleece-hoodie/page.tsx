...
export default function ProductPage() {
  ...
  const [selectedImage, setSelectedImage] = useState<string>(
    "/co-elite/CO-ELITE-FLEECE-HOODIE.jpg"
  );
  ...
  const [price, setPrice] = useState<number>(21.0);
  ...
  const productImages: string[] = ["/co-elite/CO-ELITE-FLEECE-HOODIE.jpg"];
          ...
          <div>
            ...
            <p className="text-2xl text-black-500">
              ...
              <Link href={"/team-store/aas-eagles"}>
                <span className="cursor-pointer">CO ELETE</span>
              </Link>
            </p>
          </div>
        </div>
