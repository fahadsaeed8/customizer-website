  ...
  <div className="flex flex-col min-h-screen bg-white">
    <div className="flex-1 px-6 py-[190px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {/* Product Details */}
        <div>
          <h1 className="text-[40px] font-bold mb-2">Duffle Bags</h1>
          {/* <p className="text-lg text-black-800 font-bold text-lg mb-4">$ </p> */}

          <div className="flex justify-start  text-[30px] font-bold mb-1 space-x-1">
              <span className="text-lg font-semibold !align-top">$</span>
              <span className="sm:text-4xl text-4xl font-semibold">50 </span>
            ...
            <p className="text-2xl text-black-500">
              ...
              <Link href={"/team-store/an-rams"}>
                <span className="cursor-pointer">AN-Rams</span>
              </Link>
            </p>
          </div>
        </div>
