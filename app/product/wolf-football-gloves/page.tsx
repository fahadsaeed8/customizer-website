...
export default function ProductPage() {
  ...
  const [selectedImage, setSelectedImage] = useState<string>(
    "/protomac-wolverines/Football-Gloves-2.jpg"
  );
  ...
  <div className="flex flex-col min-h-screen bg-white">
    <div className="flex-1 px-6 py-[190px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {/* Product Details */}
        <div>
          <h1 className="text-[40px] font-bold mb-2">Football Gloves</h1>
          ...
          <div className="flex justify-start  text-[30px] font-bold mb-1 space-x-1">
              ...
              <span className="sm:text-4xl text-4xl font-semibold">30 </span>
