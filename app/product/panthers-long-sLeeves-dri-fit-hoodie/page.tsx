...
export default function ProductPage() {
  ...
  const [selectedImage, setSelectedImage] = useState<string>(
    "/w-panthers/Long-SLeeves-Dri-fit-Hooodie.jpg"
  );
  ...
  <div className="flex flex-col min-h-screen bg-white">
    <div className="flex-1 px-6 py-[190px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {/* Product Details */}
        <div>
          <h1 className="text-[38px] font-bold mb-2">Long SLeeves Dri-fit Hoodie</h1>
          <p className="text-lg text-black-800 font-bold text-lg mb-4">$ 40</p>
...
>
  Send inquiry
          ...
          <p className="text-lg text-black-500">
            <span className="font-bold">Category:</span> <span className="underline">W-Panthers</span>
          </p>
        </div>
      </div>
