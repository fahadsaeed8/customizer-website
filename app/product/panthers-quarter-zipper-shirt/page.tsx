...
const [quantity, setQuantity] = useState<number>(1);
    const [price, setPrice] = useState<number>(43.0);
...
return (
    ...
    <div className="flex-1 px-6 py-[190px]">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  <h1 className="text-[40px] font-bold mb-2">Quarter Zipper Shirt</h1>
                  ...
                  <p className="text-2xl text-black-500">
                    ...
                    <Link href={"/team-store/aas-eagles"}>
                      <span className="cursor-pointer">W Panther</span>
                    </Link>
                  </p>
                </div>
              </div>
