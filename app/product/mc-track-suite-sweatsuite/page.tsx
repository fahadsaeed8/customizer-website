...
export default function ProductPage() {
  ...
  const [selectedImage, setSelectedImage] = useState<string>(
    "/mc-kenly-tec/Track-suit-min3.jpg"
  );
  ...
  <div className="flex flex-col min-h-screen bg-white">
    <div className="flex-1 px-6 py-[190px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {/* Product Details */}
        <div>
          <h1 className="text-[38px] font-bold mb-2">Track-suite / Sweatsuite</h1>
          <p className="text-lg text-black-800 font-bold text-lg mb-4">$ 70</p>
...
>
  Send inquiry
          ...
          <p className="text-lg text-black-500">
            <span className="font-bold">Category:</span> <span className="underline">Mc Kenly-Tec</span>
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-wrap gap-6 justify-center">
         <ProductCardWithPrice
          ...
          <ProductCardWithPrice
            ...
            imageSrc="/mc-kenly-tec/Spats-min3.jpg"
            price={20-22}
            link="/mc-kenly-tec/Spats-min3.jpg"
          />
        </div>
      </div>
