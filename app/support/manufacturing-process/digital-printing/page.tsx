...
const images: ImageType[] = [
  {
    src: "/support/digital-01.jpg",
  },
  {
    src: "/support/digital02.jpg",
  },
  {
    src: "/support/digital03.jpg",
  },
  {
    src: "/support/digital04.jpg",
  },
];
...
export default function SizeReferencePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      >
        <img
          src="/support/digital-hero.jpg"
          alt="Hero image"
          className="w-full h-full object-cover md:object-center block"
        />
      </div>
