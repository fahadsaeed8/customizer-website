  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="w-full bg-gray-100 border-b border-gray-300" style={{ marginTop: "160px", height: "80vh"}}>
        <img
          src="/support/subli02-1536x360-hero.jpg"
          alt="Hero image"
      ...
      <div className="flex-1 flex flex-col items-center">
        ...
        <div className="text-center mt-8 mb-8">
          <h1 className="text-4xl font-bold tracking-wide">PROSIX: Sublimated Printing</h1>
        </div>
