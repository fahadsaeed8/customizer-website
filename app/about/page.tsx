  ...
  return (
    <div>
      <div className="max-w-6xl mx-auto px-4 py-[180px] text-center">
        <p className="text-[38px] font-bold mb-6 uppercase">About Us</p>

        <p className="text-[17px] text-start text-gray-700 mb-6">
          <strong>Phenix Sports</strong> is powered by Dreams, Champions &
          Apparel.
        </p>

        <p className="text-[18px] text-gray-600 mb-6 leading-relaxed text-justify">
