...
const page = () => {
  ...
  return (
    <div>
      <div className="px-6 md:px-20  min-h-screen flex flex-wrap gap-10">
        <div className="scroll-animate-left py-[40px] mt-35 max-w-[400px] flex-1">
          <h2 className="text-[52px] font-extrabold mb-2">TEAM WEAR</h2>
          <p className="text-[24px] font-extrabold uppercase text-black mb-1">
        ...
        <div className="grid grid-cols-1 py-[180px] sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 flex-1 scroll-animate-down">
